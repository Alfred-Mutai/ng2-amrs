...
@Component({
  selector: 'app-ncddaily-register',
  templateUrl: './ncddaily-register.component.html',
  styleUrls: ['./ncddaily-register.component.css']
})
export class NcddailyRegisterComponent implements OnInit {
  @Output()
  public params: any;
