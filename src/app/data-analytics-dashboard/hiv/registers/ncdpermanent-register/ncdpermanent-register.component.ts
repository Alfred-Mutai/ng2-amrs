...
@Component({
  selector: 'app-ncdpermanent-register',
  templateUrl: './ncdpermanent-register.component.html',
  styleUrls: ['./ncdpermanent-register.component.css']
})
export class NcdpermanentRegisterComponent implements OnInit {
  @Output()
  public params: any;
  ...
  public reportName = 'NCD Permanent Register';
  ...
  ngOnInit() {
    this.getPrEPRegisterReport(null);
  }
  ...
  public getPrEPRegisterReport(params: any) {
    this.prepRegisterData = [
      {
        serialNo: 1,
        dateEnrolled: '2025-01-12',
        patientNo: 'DM/HTN/00123',
        ...
        subCounty: 'Kasarani',
        village: 'Mwiki',
        landmark: 'Near Mwiki Health Centre',
        supporterContact: '0723456789 (Husband)',
        diagnosisAtEnrollment: 'b, d', // T2DM, Hypertension
        yearOfDiagnosis: 2019,
        complicationsAtEnrollment: 'a, m', // Retinopathy, Obesity
        treatmentAtEnrollment: 'a, b, e', // Diet, OGLAs, Antihypertensive
        nhif: 'Y',
        remarks: 'Stable on treatment'
      },
      {
        serialNo: 2,
        dateEnrolled: '2025-01-15',
        patientNo: 'DM/HTN/00124',
        patientName: 'John Otieno Odhiambo',
        sex: 'M',
        dob: '1972-03-09',
        telephone: '0700112233',
        subCounty: 'Embakasi East',
        village: 'Pipeline',
        landmark: 'Pipeline Primary School',
        supporterContact: '0711223344 (Wife)',
        diagnosisAtEnrollment: 'a',
        yearOfDiagnosis: 2025,
        complicationsAtEnrollment: 'n, o',
        treatmentAtEnrollment: 'a, d',
        nhif: 'N',
        remarks: 'New enrolment'
      }
    ];
