...
@Component({
  selector: 'app-ncdmonthly-register',
  templateUrl: './ncdmonthly-register.component.html',
  styleUrls: ['./ncdmonthly-register.component.css']
})
export class NcdmonthlyRegisterComponent implements OnInit {
  @Output()
  public params: any;
  ...
  public reportName = 'NCD Daily Activity Register';
  ...
  public getPrEPRegisterReport(params: any) {
    this.prepRegisterData = [
      ...
      },
      {
        ...
        diabeticFoot: 'New',
        footRisk: 'B',
        footOutcome: 'Debridement',
        tbScreened: 'N',
        tbStatus: 'N/A',
        activeNhif: 'No',
        remarks: 'Referred to specialist'
      }
    ];
